...
<div class="max-w-7xl mx-auto">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Kelola pendaftaran peserta ke event</p>
        </div>
    ...
    <div class="mb-6">
        <form method="GET" action="{{ route('admin.registrations.index') }}" class="relative max-w-md">
            ...
            @if(request('search'))
                <a href="{{ route('admin.registrations.index') }}" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600" aria-label="Hapus pencarian">
