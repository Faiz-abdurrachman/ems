...
<div class="max-w-2xl mx-auto">
    ...
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
        <div class="border-b border-gray-200 px-6 py-4">
            <h2 class="text-lg font-semibold text-gray-900">Add Participant</h2>
            <p class="mt-0.5 text-sm text-gray-500">Register a new participant in the system.</p>
        </div>

        <form action="{{ route('participants.store') }}" method="POST" class="px-6 py-5 space-y-5">
            @csrf
