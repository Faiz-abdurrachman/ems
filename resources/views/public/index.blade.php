...
<div class="mx-auto max-w-7xl px-6">
    <div class="text-center mb-10">
        ...
        <p class="mt-3 text-lg text-ink/50 font-bold">Daftar event mendatang yang bisa kamu ikuti</p>
    ...
    @if($events->isEmpty())
        <div class="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p class="mt-1 text-ink/50 font-bold">Event mendatang akan muncul di sini.</p>
        </div>
    @else
            ...
            @foreach($events as $event)
                <a href="{{ route('events.show', $event) }}" class="group block border-2 border-black bg-white shadow-[6px_6px_0px_0px_#000] hover:shadow-md transition-shadow overflow-hidden">
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-3 flex items-center gap-4 text-xs text-ink/50 font-bold">
