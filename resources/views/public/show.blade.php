                    ...
                    <form method="POST" action="{{ route('events.register', $event) }}" class="mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                class="mt-1 block w-full rounded-none border-black shadow-[4px_4px_0px_0px_#000] focus:bg-cyan/20 focus:outline-none sm:text-sm {{ $errors->has('name') ? 'border-red-300' : '' }}"
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" required
                                class="mt-1 block w-full rounded-none border-black shadow-[4px_4px_0px_0px_#000] focus:bg-cyan/20 focus:outline-none sm:text-sm {{ $errors->has('email') ? 'border-red-300' : '' }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" id="phone" value="{{ old('phone') }}"
                                class="mt-1 block w-full rounded-none border-black shadow-[4px_4px_0px_0px_#000] focus:bg-cyan/20 focus:outline-none sm:text-sm {{ $errors->has('phone') ? 'border-red-300' : '' }}"
